...
_yuitest_coverage["build/gallery-algorithms/gallery-algorithms.js"].functions = {"swap:25":0,"compareStringsCaseSensitive:41":0,"compareStringsCaseInsensitive:62":0,"(anonymous 2):78":0,"compareForFind:76":0,"qsort1:96":0,"qsortRange:150":0,"quickSort:172":0,"binarySearch:194":0,"swap:259":0,"setComparator:270":0,"quickSort:280":0,"binarySearch:292":0,"(anonymous 1):1":0};
_yuitest_coverage["build/gallery-algorithms/gallery-algorithms.js"].coveredLines = 87;
_yuitest_coverage["build/gallery-algorithms/gallery-algorithms.js"].coveredFunctions = 14;
 ...
 */
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 76);
Y.Array.compareForFind = function(f)
{
	_yuitest_coverfunc("build/gallery-algorithms/gallery-algorithms.js", "compareForFind", 76);
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 78);
return function(a,b)
	{
		_yuitest_coverfunc("build/gallery-algorithms/gallery-algorithms.js", "(anonymous 2)", 78);
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 80);
return (f(a,b) === 0);
	};
};
...
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 96);
function qsort1(list,i1,i2,compare)
{
	_yuitest_coverfunc("build/gallery-algorithms/gallery-algorithms.js", "qsort1", 96);
...
if (!compare)
		{
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 102);
compare = Y.Array.compareStringsCaseSensitive;
		}

	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 105);
...
ip=n--;
	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 108);
pivot=list[ip];
...
m=n--;
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 112);
b=(compare(pivot, list[m])===0);
		}
	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 114);
...
m=n++;
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 118);
b=(compare(pivot, list[m])===0);
		}
	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 120);
if (b) { return -1; }
...
m=i2;  // Right
	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 128);
while (n<=m)
		{
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 130);
while (compare(pivot, list[n]) > 0)
			{
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 132);
n++;
			}
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 134);
...
if (n<m)
			{
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 140);
s=list[m];
...
list[n]=s;
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 143);
m--;
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 144);
n++;
			}
		}
	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 147);
return n;
}

_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 150);
function qsortRange(list,first,last,compare)
{
	_yuitest_coverfunc("build/gallery-algorithms/gallery-algorithms.js", "qsortRange", 150);
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 152);
var center; // This local var is the only recursive stack space used
	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 153);
if (first<last)
		{
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 155);
center=qsort1(list,first,last,compare);
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 156);
if (center!=-1)
			{
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 158);
qsortRange(list,first,center-1,compare);
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 159);
qsortRange(list,center,last,compare);
			}
		}
}
 ...
 */
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 172);
Y.Array.quickSort = function(list,compare)
{
	_yuitest_coverfunc("build/gallery-algorithms/gallery-algorithms.js", "quickSort", 172);
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 174);
 ...
 */
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 194);
Y.Array.binarySearch = function(list, target, compare)
{
	_yuitest_coverfunc("build/gallery-algorithms/gallery-algorithms.js", "binarySearch", 194);
...
if (!compare)
		{
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 203);
compare = Y.Array.compareStringsCaseSensitive;
		}
...
var high = list.length - 1;
	...
	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 209);
var lastTry;
	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 210);
while (low <= high)
	{
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 212);
var mid  = (low + high) / 2;
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 213);
var aTry = (mid < 1) ? 0 : parseInt(mid, 10);

		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 215);
var c = compare(list[aTry], target);
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 216);
if (c < 0)
		{
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 218);
low = aTry + 1;
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 219);
continue;
		}
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 221);
if (c > 0)
		{
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 223);
high = aTry - 1;
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 224);
continue;
		}
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 226);
if (c === 0)
		{
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 228);
high = aTry - 1;
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 229);
lastTry = aTry;
			_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 230);
continue;
		}
		_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 232);
return aTry;
	}

	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 235);
...
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 241);
if (Y.ArrayList)
{
	/**********************************************************************
	...
	_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 250);
Y.mix(Y.ArrayList,
	{
		/**
		...
		swap: function(i,j)
		{
			_yuitest_coverfunc("build/gallery-algorithms/gallery-algorithms.js", "swap", 259);
...
Y.Array.swap(this._items, i,j);
		...
		{
			_yuitest_coverfunc("build/gallery-algorithms/gallery-algorithms.js", "setComparator", 270);
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 272);
this._compare = compare;
		...
		quickSort: function()
		{
			_yuitest_coverfunc("build/gallery-algorithms/gallery-algorithms.js", "quickSort", 280);
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 282);
Y.Array.quickSort(this._items, this._compare);
		...
		{
			_yuitest_coverfunc("build/gallery-algorithms/gallery-algorithms.js", "binarySearch", 292);
_yuitest_coverline("build/gallery-algorithms/gallery-algorithms.js", 294);
