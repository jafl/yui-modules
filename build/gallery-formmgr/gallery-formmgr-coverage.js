...
this.postPopulateForm();
	...
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "populateForm", 703);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 705);
if (!this.default_value_map)
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 707);
this.default_value_map = {};
		}

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 710);
this.clearMessages();

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 712);
populateForm1.call(this);

		// let derived class adjust

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 716);
this.postPopulateForm();
	},
	...
	isChanged: function()
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "isChanged", 735);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 737);
for (var i=0; i<this.form.elements.length; i++)
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 739);
var e = this.form.elements[i];
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 740);
if (!e.name)
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 742);
continue;
			}
...
var v    = this.default_value_map[ e.name ];
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 748);
if (v === null || typeof v === 'undefined')
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 750);
v = "";
			}

			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 753);
if (name == 'input' && type == 'file')
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 755);
if (e.value)
				{
					_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 757);
return true;
				}
			}
			else {_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 760);
if (name == 'input' &&
					 (type == 'password' || type == 'text' || type == 'file'))
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 763);
if (e.value != v)
				{
					_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 765);
return true;
				}
			}
			else {_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 768);
if (name == 'input' &&
					 (type == 'checkbox' || type == 'radio'))
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 771);
var checked = (e.value == v);
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 772);
if ((checked && !e.checked) || (!checked && e.checked))
				{
					_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 774);
return true;
				}
			}
			else {_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 777);
if ((name == 'select' && type == 'select-one') ||
					 name == 'textarea')
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 780);
if (e.value != v)
				{
					_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 782);
return true;
				}
			}}}}
		}

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 787);
return false;
	},
	...
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "prepareForm", 796);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 798);
this.getForm();

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 800);
if (!this.prePrepareForm.apply(this, arguments))
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 802);
return false;
		}

		// fill in starting values

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 807);
this.populateForm();

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 809);
return this.postPrepareForm.apply(this, arguments);
	...
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "prePrepareForm", 818);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 820);
return true;
	},
	...
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "postPrepareForm", 829);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 831);
return true;
	},
	...
	initFocus: function()
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "initFocus", 840);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 842);
for (var i=0; i<this.form.elements.length; i++)
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 844);
var e = this.form.elements[i];
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 845);
if (e.disabled || e.offsetHeight === 0)
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 847);
continue;
			}

			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 850);
var name = e.tagName.toLowerCase();
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 851);
var type = (e.type ? e.type.toLowerCase() : null);

			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 853);
if ((name == 'input' &&
				 (type == 'file' || type == 'password' || type == 'text')) ||
				name == 'textarea')
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 857);
try
				{
					_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 859);
e.focus();
				}
				catch (ex)
				{
...
e.select();
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 866);
break;
			}
		}
	},
	...
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "validateForm", 875);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 877);
this.clearMessages();
		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 878);
var status = true;

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 880);
var e                = this.form.elements;
		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 881);
this.has_file_inputs = FormManager.cleanValues(e);

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 883);
for (var i=0; i<e.length; i++)
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 885);
var e_id     = e[i].id;
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 886);
...
var info = FormManager.validateFromCSSData(e[i], msg_list);
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 889);
if (info.error)
			{
...
status = false;
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 893);
continue;
			}

			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 896);
if (info.keepGoing)
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 898);
...
status = false;
					_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 903);
continue;
				}
			}
...
var scope = this;
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 909);
if (Y.Lang.isFunction(f))
			{
				// use it
			}
			else {_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 913);
if (Y.Lang.isString(f))
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 915);
f = scope[f];
			}
			else {_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 917);
if (f && f.scope)
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 919);
scope = f.scope;
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 920);
f     = (Y.Lang.isString(f.fn) ? scope[f.fn] : f.fn);
			}
			else
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 924);
f = null;
			}}}

			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 927);
if (f && !f.call(scope, this.form, Y.one(e[i])))
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 929);
status = false;
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 930);
continue;
			}
		}

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 934);
if (!this.postValidateForm(this.form))
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 936);
status = false;
		}

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 939);
if (!status)
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 941);
this.notifyErrors();
		}

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 944);
return status;
	},
	...
	postValidateForm: function(
		/* DOM element */	form)
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "postValidateForm", 954);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 957);
return true;
	},
	...
	registerButton: function(
		/* string/object */ el)
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "registerButton", 973);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 976);
var info =
		{
			e: Y.Lang.isString(el) || el.tagName ? Y.one(el) : el
		};

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 981);
this.user_button_list.push(info);
	...
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "isFormEnabled", 988);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 990);
return this.enabled;
	},
	...
	enableForm: function()
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "enableForm", 998);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1000);
this.setFormEnabled(true);
	...
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "disableForm", 1008);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1010);
this.setFormEnabled(false);
	...
	setFormEnabled: function(
		/* boolean */	enabled)
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "setFormEnabled", 1019);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1022);
this.enabled = enabled;

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1024);
var disabled = ! enabled;
		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1025);
for (var i=0; i<this.button_list.length; i++)
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1027);
this.button_list[i].disabled = disabled;
		}

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1030);
...
var info = this.user_button_list[i];
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1033);
info.e.set('disabled', disabled);
	...
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "hasMessages", 1045);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1047);
return this.has_messages;
	...
	hasErrors: function()
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "hasErrors", 1054);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1056);
return this.has_errors;
	...
	getRowStatus: function(
		/* id/object */	e)
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "getRowStatus", 1066);
...
var p = Y.one(e).getAncestorByClassName(FormManager.row_marker_class, true);
		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1070);
return FormManager.getElementStatus(p);
	...
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "clearMessages", 1078);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1080);
this.has_messages = false;
		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1081);
this.has_errors   = false;

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1083);
if (this.status_node)
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1085);
this.status_node.set('innerHTML', '');
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1086);
this.status_node.replaceClass(statusPattern(), FormManager.status_none_class);
		}

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1089);
Y.Array.each(this.form.elements, function(e)
		{
			_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "(anonymous 2)", 1089);
...
var type = (e.type ? e.type.toLowerCase() : null);
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1093);
if (name != 'button' && type != 'submit' && type != 'reset')
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1095);
FormManager.clearMessage(e);
			}
		});

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1099);
Y.one(this.form).all('fieldset').removeClass(rowStatusPattern());
	...
	displayMessage: function(
		...
		/* boolean */	scroll)
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "displayMessage", 1114);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1120);
...
this.has_messages = true;
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1123);
if (type == 'error')
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1125);
this.has_errors = true;
			}

			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1128);
return true;
		}
		else
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1132);
return false;
		}
	},
	...
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "notifyErrors", 1143);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1145);
this.displayFormMessage(FormManager.Strings.validation_error, true, false);
	...
	displayFormMessage: function(
		...
		/* boolean */	scroll)
	{
		_yuitest_coverfunc("build/gallery-formmgr/gallery-formmgr.js", "displayFormMessage", 1156);
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1161);
if (Y.Lang.isUndefined(scroll))
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1163);
scroll = true;
		}

		_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1166);
if (this.status_node)
		{
			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1168);
if (!this.status_node.innerHTML)
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1170);
this.status_node.replaceClass(
				...
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1174);
this.status_node.set('innerHTML', msg);
			}

			_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1177);
if (scroll)
			{
				_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1179);
...
_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1189);
Y.aggregate(FormManager, Y.FormManager);

_yuitest_coverline("build/gallery-formmgr/gallery-formmgr.js", 1191);
