...
yy: {},
symbols_: {"error":2,"expressions":3,"e":4,"EOF":5,"NUMBER":6,"E":7,"PI":8,"I":9,"(":10,")":11,"+":12,"-":13,"*":14,"/":15,"^":16,"ABS":17,"PHASE":18,"CONJUGATE":19,"ROTATE":20,"arglist":21,"RE":22,"IM":23,"MIN":24,"MAX":25,"SQRT":26,"LN":27,"ARCSIN":28,"ARCCOS":29,"ARCTAN":30,"ARCTAN2":31,"SIN":32,"COS":33,"TAN":34,"SINH":35,"COSH":36,"TANH":37,"ARCSINH":38,"ARCCOSH":39,"ARCTANH":40,",":41,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"NUMBER",7:"E",8:"PI",9:"I",10:"(",11:")",12:"+",13:"-",14:"*",15:"/",16:"^",17:"ABS",18:"PHASE",19:"CONJUGATE",20:"ROTATE",22:"RE",23:"IM",24:"MIN",25:"MAX",26:"SQRT",27:"LN",28:"ARCSIN",29:"ARCCOS",30:"ARCTAN",31:"ARCTAN2",32:"SIN",33:"COS",34:"TAN",35:"SINH",36:"COSH",37:"TANH",38:"ARCSINH",39:"ARCCOSH",40:"ARCTANH",41:","},
productions_: [0,[3,2],[4,1],[4,1],[4,1],[4,1],[4,3],[4,3],[4,3],[4,3],[4,3],[4,3],[4,2],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[4,4],[21,1],[21,3]],
...
break;
case 22:this.$ = new yy.MathFunction.NaturalLog($$[$0-1]);
break;
case 23:this.$ = new yy.MathFunction.Arcsine($$[$0-1]);
break;
case 24:this.$ = new yy.MathFunction.Arccosine($$[$0-1]);
break;
case 25:this.$ = new yy.MathFunction.Arctangent($$[$0-1]);
break;
case 26:this.$ = new yy.MathFunction.Arctangent2($$[$0-1]);
break;
case 27:this.$ = new yy.MathFunction.Sine($$[$0-1]);
break;
case 28:this.$ = new yy.MathFunction.Cosine($$[$0-1]);
break;
case 29:this.$ = new yy.MathFunction.Tangent($$[$0-1]);
break;
case 30:this.$ = new yy.MathFunction.HyperbolicSine($$[$0-1]);
break;
case 31:this.$ = new yy.MathFunction.HyperbolicCosine($$[$0-1]);
break;
case 32:this.$ = new yy.MathFunction.HyperbolicTangent($$[$0-1]);
break;
case 33:this.$ = new yy.MathFunction.InverseHyperbolicSine($$[$0-1]);
break;
case 34:this.$ = new yy.MathFunction.InverseHyperbolicCosine($$[$0-1]);
break;
case 35:this.$ = new yy.MathFunction.InverseHyperbolicTangent($$[$0-1]);
break;
case 36:this.$ = [ $$[$0] ];
break;
...
lexer.rules = [/^0[xX][0-9a-fA-F]+/,/^[0-9]+[eE][-+]?[0-9]+/,/^[0-9]+\.([0-9]+)?([eE][-+]?[0-9]+)?/,/^([0-9]+)?\.[0-9]+([eE][-+]?[0-9]+)?/,/^[1-9][0-9]*/,/^0\b/,/^pi\b/,/^e\b/,/^i\b/,/^\*/,/^\//,/^-/,/^\+/,/^\^/,/^\(/,/^\)/,/^,/,/^re\b/,/^im\b/,/^abs\b/,/^phase\b/,/^conjugate\b/,/^rotate\b/,/^max\b/,/^min\b/,/^sqrt\b/,/^ln\b/,/^arcsin\b/,/^arccos\b/,/^arctan\b/,/^arctan2\b/,/^sin\b/,/^cos\b/,/^tan\b/,/^sinh\b/,/^cosh\b/,/^tanh\b/,/^arcsinh\b/,/^arccosh\b/,/^arctanh\b/,/^\s+/,/^$/];
