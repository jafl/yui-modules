...
return time;
		...
		else {_yuitest_coverline("build/gallery-datetime-utils/gallery-datetime-utils.js", 280);
if (self.CLOCK_DISPLAY_TYPE == 12)
		{
			_yuitest_coverline("build/gallery-datetime-utils/gallery-datetime-utils.js", 282);
...
return (time.hour > 12 ?
		...
		{
			_yuitest_coverline("build/gallery-datetime-utils/gallery-datetime-utils.js", 289);
return time.hour + self.TIME_FIELD_DELIMITER + pad2(time.minute);
	...
	parseTime: function(
		/* string */	time)
	{
		_yuitest_coverfunc("build/gallery-datetime-utils/gallery-datetime-utils.js", "parseTime", 303);
...
time   = Y.Lang.trim(time.replace(self.PM_STRING, ''));
			_yuitest_coverline("build/gallery-datetime-utils/gallery-datetime-utils.js", 323);
offset = 12;
		}}
...
if (t.length != 2 || !Y.every(t, validInteger))
		{
			_yuitest_coverline("build/gallery-datetime-utils/gallery-datetime-utils.js", 329);
...
var result =
		...
		_yuitest_coverline("build/gallery-datetime-utils/gallery-datetime-utils.js", 338);
if (result.hour   < 0 || 23 < result.hour ||
			result.minute < 0 || 59 < result.minute)
		{
			_yuitest_coverline("build/gallery-datetime-utils/gallery-datetime-utils.js", 341);
throw Error('Invalid time values: ' + result.hour + self.TIME_FIELD_DELIMITER + pad2(result.minute));
		}

		_yuitest_coverline("build/gallery-datetime-utils/gallery-datetime-utils.js", 344);
return result;
	}
};
