...
}, '@VERSION@' ,{optional:['gallery-scrollintoview'], skinnable:true, requires:['datatable-base','gallery-formmgr-css-validation','gallery-node-optimizations','gallery-funcprog']});
